...
<body>
    <div class="container">
        ...
        <div class="section">
                ...
                if($employee) {
                    ...
                    if($payroll) {
                        ...
                        <div class="calculation-details">
                            <button class="print-btn" onclick="window.location.href='../payroll/print_payroll.php?calc_employee_id=<?php echo $employee_id; ?>'">បោះពុម្ព (Print)</button>
            ...
            ?>
            <a href="../payroll/payroll.php">ត្រឡប់ទៅទំព័រគ្រប់គ្រងប្រាក់ខែ</a>
        </div>
    </div>
</body>
</html>