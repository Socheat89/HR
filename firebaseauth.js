 ...
 signUp.addEventListener('click', (event)=>{
    ...
    .then((userCredential)=>{
        ...
        showMessage('បានបង្កើតរូចរាល់!', 'signUpMessage');
 ...
 signIn.addEventListener('click', (event)=>{
    ...
    .catch((error)=>{
        ...
        if(errorCode==='auth/invalid-credential'){
            showMessage('សូមពិនិត្យពាក្យសម្ងាត់និងអ៊ីមែលម្តងទៀត', 'signInMessage');
        }
        else{
            showMessage('សូមបំពេញគណនីរបស់អ្នក', 'signInMessage');
        }
    })
 })
