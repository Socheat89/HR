...
// Use: login.php?clear_cache=1 (must be called from the server itself)
...
<div class="login-card" role="main" aria-labelledby="loginTitle">
    ...
    <form id="loginForm" method="POST" novalidate>
        ...
        <?php else: ?>
            ...
            <input class="field" type="text" name="username" placeholder="ឈ្មោះអ្នកប្រើ" autocomplete="username" required />
            <div class="field password-container">
                <input type="password" name="password" placeholder="ពាក្យសម្ងាត់" autocomplete="current-password" required />
