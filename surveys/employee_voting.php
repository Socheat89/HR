...
require_once '../system/log.php'; // Ensure log.php exists and is correctly configured
...
<head>
    ...
    <style>
        ...
        .app-header { background: rgba(250, 204, 21, 0.9) !important; border-color: rgba(255,255,255,0.3) !important; border-radius: 20px !important; margin-top: 20px !important; padding: 15px 25px !important; }
        ...
        .user-name { color: var(--primary-dark) !important; }
        .card::after { 
        ...
        .app-header { background: rgba(234, 88, 12, 0.9) !important; border-color: rgba(255,255,255,0.3) !important; border-radius: 20px !important; margin-top: 20px !important; padding: 15px 25px !important; }
        ...
        .app-header { background: rgba(220, 38, 38, 0.9) !important; border-color: rgba(255,255,255,0.3) !important; border-radius: 20px !important; margin-top: 20px !important; padding: 15px 25px !important; }
        .app-title { background: none !important; -webkit-text-fill-color: white !important; color: white !important; text-shadow: 0 1px 2px rgba(0,0,0,0.1); }
        .user-name { color: white !important; }
        .card::after { 
            content: ""; position: absolute; bottom: 10px; right: 10px; width: 60px; height: 60px;
        ...
        .app-header { background: rgba(2, 132, 199, 0.9) !important; border-color: rgba(255,255,255,0.3) !important; border-radius: 20px !important; margin-top: 20px !important; padding: 15px 25px !important; }
        .app-title { background: none !important; -webkit-text-fill-color: white !important; color: white !important; text-shadow: 0 1px 2px rgba(0,0,0,0.1); }
        .user-name { color: white !important; }
        .card::after { 
...
<body>
    <div class="app-container">
        <header class="app-header animate__animated animate__fadeInDown">
            <a href="../homes.php" style="text-decoration: none;">
        ...
        <h2 class="mb-4 text-center" style="font-weight: 700; color: var(--primary-dark); text-shadow: 0 1px 2px rgba(0,0,0,0.05);">ការបោះឆ្នោតបុគ្គលិក</h2>
