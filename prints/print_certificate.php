...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['role']) || $_SESSION['role'] !== 'admin') {
    $_SESSION['error'] = 'свссссссс╢ссс╖сссс╖сс╝сссссРсссБсссБс';
...
try {
    ...
    $_SESSION['error'] = 'сс╢сссссас╢сссс╗ссс╢ссПсссс╢сссс╖сссссРсс сс╝ссссс╢сс╢ссссПссссПс';
...
function convertToKhmerNumerals($num) {
    $map = [
        '0' => 'са','1' => 'сб','2' => 'св','3' => 'сг','4' => 'сд',
        '5' => 'се','6' => 'сж','7' => 'сз','8' => 'си','9' => 'сй'
    ];
    $s = (string)$num;
    $out = '';
    ...
    try {
        ...
        if (count($vote_results) > 0) {
            ...
            foreach ($top_3_candidates as $index => $candidate) {
                $rank_number = $index + 1;
                $rank_text = 'ссБсБ ' . convertToKhmerNumerals($rank_number);
                ...
                if ($w_data) {
                    ...
                    if (!empty($w_data['gender'])) {
                        ...
                        if ($gender_val === 'male' || $gender_val === 'сссс╗с') {
                            $w_gender_kh = 'сссс╗с';
                        } else if ($gender_val === 'female' || $gender_val === 'сссс╕') {
                            $w_gender_kh = 'сссс╕';
                        }
                    }
                    ...
                    if ($employee_type === 'specialist') {
                        $desc_default = 'сс╗ссссс╖сссссс <span style="font-family: \'Khmer OS Muol Light\'; color: #2b36f3; font-weight: bold;"> ' . $w_name . ' </span> ссБс  ' . $w_gender_kh . '  сс╢сс╗ссссс╖сссссс <span style="font-family: \'Khmer OS Muol Light\'; color: #2b36f3; font-weight: bold;"> ' . $w_department_kh . ' </span><br>
                            ссссс╢ссБс╖сПсБссссс╗ссПс╜сс╢сс╕сссссБссс╜ссс╢сссс╢ссссвсссс╗ссс╢сссссБссс╢ссс╢ссс╝ссссс╗ссасс╗с сс╖ссс╢ссс╢сс<br>
                            сс╢сс╗ссссс╖ссссс╛сссссс <span style="font-family: \'Khmer OS Muol Light\'; color: #2b36f3; font-weight: bold;"> ' . htmlspecialchars($warehouse) . ' </span> ссссс╢с <span style="font-family: \'Khmer OS Muol Light\'; color: #2b36f3; font-weight: bold;"> ' . htmlspecialchars($poll_question_display) . ' </span>   сссссс╢с свсасвсе с';
                    } else {
                        $desc_default = 'сс╗ссссс╖сссссс <span style="font-family: \'Khmer OS Muol Light\'; color: #2b36f3; font-weight: bold;"> ' . $w_name . ' </span> ссБс  ' . $w_gender_kh . '  сс╢сс╗ссссс╖сссссс <span style="font-family: \'Khmer OS Muol Light\'; color: #2b36f3; font-weight: bold;"> ' . $w_department_kh . ' </span><br>
                            ссссс╢ссБс╖сПсБссссс╗ссПс╜сс╢сс╕сссссБссс╜ссс╢сссс╢ссссвсссс╗ссс╢сссссБссс╢ссс╢ссс╝ссссс╗ссасс╗с сс╖ссс╢ссс╢сс<br>
                            сс╢сс╗ссссс╖ссссс╛с ' . $rank_text . ' сссссс╢сс <span style="font-family: \'Khmer OS Muol Light\'; color: #2b36f3; font-weight: bold;"> ' . htmlspecialchars($warehouse) . ' </span> ссссс╢с <span style="font-family: \'Khmer OS Muol Light\'; color: #2b36f3; font-weight: bold;"> ' . htmlspecialchars($poll_question_display) . ' </span>   сссссс╢с свсасвсе с';
                    }
                    ...
                    // Default Date
                    $default_date = "сРссссс╗с сбссс сБссвсссс╗с сссс╢ссссс╢сс ссссссРс с.с свсесжсй<br>сс╢ссс╢сс╕ссссссБс, сРссссс╕сбсд сБссПс╗сс╢ сссс╢ссвсасвсе";
                    ...
                    $top_winners[] = [
                        ...
                        'title_main'    => getSavedText($db, $poll_id, $user_id_val, 'title_main', 'сс╖сБс╖сПсссс╛с'),
                        'title_sub1'    => getSavedText($db, $poll_id, $user_id_val, 'title_sub1', 'свссссс╢сс╖сс╢сссс╗ссасс╗с сссс сссс сБсБссс╝сс╢'),
                        'title_sub2'    => getSavedText($db, $poll_id, $user_id_val, 'title_sub2', 'сс╝ссссс╛сссссс'),
                        ...
                        'sig_title'     => getSavedText($db, $poll_id, $user_id_val, 'sig_title', 'свссссс╢сс╖сс╢'),
                        'sig_name'      => getSavedText($db, $poll_id, $user_id_val, 'sig_name', 'сс╢с сс╗сссс'),
...
<head>
    ...
    <title>сс╖сБс╖сПсссс╛с - Inline Edit</title>
    ...
    <style>
        ...
        @font-face { font-family: 'Tacteing'; src: url('../assets/fonts/Tacteing.ttf') format('truetype'); font-weight: normal; }
...
<body>
    ...
    <button class="print-btn" onclick="window.print()"><i class="fa-solid fa-print"></i> ссссс╗ссс (Print)</button>
    <div id="saveStatus" class="save-status">сссс╗сссссс╢сс╗с...</div>
    ...
    <div class="nav-tabs">
        <a href="?poll_id=<?php echo $poll_id; ?>&winner_id=<?php echo $winner_id; ?>&bg=<?php echo urlencode($selected_bg); ?>&type=worker" class="tab-link <?php echo $type === 'worker' ? 'active' : ''; ?>">сссссс</a>
        <a href="?poll_id=<?php echo $poll_id; ?>&winner_id=<?php echo $winner_id; ?>&bg=<?php echo urlencode($selected_bg); ?>&type=specialist" class="tab-link <?php echo $type === 'specialist' ? 'active' : ''; ?>">сссс╢с</a>
    </div>
    ...
    <div class="certificate-wrapper">
        <div class="certificate-page">
            ...
            <span class="seal-rank"><?php echo !$winner['is_worker'] ? 'сб' : convertToKhmerNumerals(isset($winner['rank_num']) ? $winner['rank_num'] : preg_replace('/\D/','',$winner['rank'])); ?></span>
    ...
    <div class="certificate-page">
        <div class="certificate-content">
            <h2 style="text-align: center; color: red;">сс╖ссс╢ссс╖сссссРссвсссссссссБ</h2>
        </div>
    </div>
    <?php endif; ?>
                ...
                el.addEventListener('blur', function() {
                    ...
                    .then(data => {
                        if(data.status === 'success') {
                            showStatus('сс╢сссссс╢сс╗с!', 'success');
                        } else {
                            showStatus('ссс╢ссРс: ' + (data.message || ''), 'error');
                        }
                    })
                    .catch(err => {
                        console.error(err);
