...
require_once '../system/config.php'; // Assumes ../system/config.php provides DB_HOST, DB_NAME, DB_USER, DB_PASS
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: ../system/setting.php"); // Corrected action URL
    exit();
}
...
<body>
    ...
    <nav class="bottom-nav">
        ...
        <a href="../system/setting.php" class="nav-item active">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.confirmDeleteGroup = function(groupId) {
                if (confirm('តើអ្នកពិតជាចង់លុបក្រុម Telegram នេះមែនទេ? សកម្មភាពនេះមិនអាចត្រឡប់វិញបានទេ។ វានឹងលុបតួនាទីទាំងអស់ដែលបានកំណត់សម្រាប់ក្រុមនេះផងដែរ។')) {
                    ...
                    form.method = 'POST';
                    form.action = '../system/setting.php'; // Corrected action URL
