...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($poll_id && $winner_id && $description !== '') {
        try {
            ...
            $message = 'сс╢сссссс╢сс╗ссс╢ссс╖ссссс╢ ссссссссРсс';
        } catch (PDOException $e) {
            $message = 'сс╢сссссас╢сссс╗ссс╢сссссс╢сс╗сс сс╝ссссс╢сс╢ссссПссссПс';
            error_log("Save Description Error: " . $e->getMessage());
        }
    } else {
        $message = 'сс╝сссссБссс╖сссссРссс╢сссвссс';
    }
}
...
<head>
    <meta charset="UTF-8">
    <title>ссссс╝ссс╢ссс╖ссссс╢</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>ссссс╝ссс╢ссс╖ссссс╢</h1>
        <?php if ($message): ?>
            <p class="message"><?php echo htmlspecialchars($message); ?></p>
        <?php endif; ?>
        <form method="post">
            <label for="poll_id">сссс╛ссс╛ссс╢сссссссссП:</label>
            <select name="poll_id" id="poll_id" required>
                <option value="">-- сссс╛ссс╛с --</option>
                <?php foreach ($polls as $poll): ?>
                    <option value="<?php echo $poll['id']; ?>"><?php echo htmlspecialchars($poll['question']); ?></option>
                <?php endforeach; ?>
            </select>

            <label for="winner_id">сссс╛ссс╛ссвссссссс:</label>
            ...
            <label for="description-text">сс╢ссс╖ссссс╢:</label>
            <textarea name="description-text" id="description-text" placeholder="ссссс╝ссс╢ссс╖ссссс╢..." required></textarea>

            <button type="submit">ссссс╢сс╗с</button>
        </form>
    </div>
</body>
</html>
