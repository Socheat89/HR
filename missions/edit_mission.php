...
try {
    ...
    if (!$mission_id) {
        header("Location: ../missions/view_all_mission_letters.php");
        exit;
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        header("Location: ../missions/view_all_mission_letters.php?success=1");
        exit;
    }
...
<head>
    <meta charset="UTF-8">
    <title>កែសម្រួលលិខិតបេសកកម្ម</title>
...
<body>
    <div class="form-container">
        <h3 style="text-align: center; font-family: 'Koulen';">កែសម្រួលលិខិតបេសកកម្ម</h3>
        <form method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="person1" class="form-label">ឈ្មោះ/គោត្តនាម ១</label>
            ...
            <div class="mb-3">
                <label for="person2" class="form-label">ឈ្មោះ/គោត្តនាម ២</label>
            ...
            <div class="mb-3">
                <label for="start_date" class="form-label">ថ្ងៃចេញដំណើរ</label>
            ...
            <div class="mb-3">
                <label for="end_date" class="form-label">ថ្ងៃត្រឡប់</label>
                <input type="date" class="form-control" id="end_date" name="end_date" value="<?= htmlspecialchars($data['end_date'] ?? '') ?>">
            </div>
            <div class="mb-3">
                <label for="end_time" class="form-label">ម៉ោងត្រឡប់</label>
            ...
            <div class="mb-3">
                <label for="materials" class="form-label">សម្ភារៈយកតាមខ្លួន</label>
            ...
            <a href="../missions/view_all_mission_letters.php" class="btn btn-secondary btn-sm">បោះបង់</a>
        </form>
    </div>
</body>
</html>
