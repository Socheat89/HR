...
<head>
    ...
    <style>
        ...
        * {
        ...
        .error-message { display: none; } /* Hide error messages by default */
    </style>
</head>
<body>
    <div class="main-remove">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#productAccordion">
                                            <?php foreach ($sub_sections as $key => $name): ?>
                                                <a class="nav-link<?php echo $key === 'best_sellers' ? ' active-menu' : ''; ?>" href="#<?php echo $key; ?>"><?php echo $name; ?></a>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="sub-menu">
            <ul>
                <?php foreach ($sub_sections as $key => $name): ?>
                    <li><a href="#<?php echo $key; ?>" class="nav-link<?php echo $key === 'best_sellers' ? ' active-menu' : ''; ?>"><?php echo $name; ?> <?php echo $key !== 'gofresh' ? ' <span style="color: gold;">|</span>' : ''; ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
