...
<head>
    ...
    <meta name="theme-color" content="#2563ទ3eb">
        ...
        $(document).ready(function() {
            ...
            window.addEventListener('beforeinstallprompt', (e) => {
                ...
                if (localStorage.getItem('pwaInstallDismissed') !== 'true') {
                    ...
                    console.log('Install prompt skipped due to dismissal');
                }
            });
            ...
            $('#chat-form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        console.error('Message send failed:', status, error);
                    }
                });
            });
            ...
            function loadMessages() {
                if (receiverId) {
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            console.error('Message load failed:', status, error);
                        }
                    });
                }
            }
