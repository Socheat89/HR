...
<body>
  ...
  <form id="form" onsubmit=" return sender()" class=" pl-0 main-form-request font-change" method="POST">
    <div class="container mt-3">
        ...
        <div class="mt-6 f-boks card bg-white text-white shadow p-2 mb-2">
          <div class="field">
      ...
      <div class="container justify-content-end mt-5 text-center btn-home">
        <!-- "Go to Home" Button -->
