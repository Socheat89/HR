...
try {
    ...
    error_log('form_input.php - user_id: ' . $_SESSION['user_id'] . ', role: ' . $user['role']);
...
try {
    ...
    error_log('form_input.php - Fetched ' . count($users) . ' users for dropdown');
} catch (PDOException $e) {
...
if ($employee_id) {
    try {
        ...
        error_log('form_input.php - Loaded employee data for id: ' . $employee_id);
    } catch (PDOException $e) {
...
<body>
    <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data" id="employee-form" action="save_request.php" onsubmit="return validateForm()">
            ...
            <div class="form-section">
                ...
                <a href="table.php" class="cancel-btn">បោះបង់</a>
            </div>
        </form>
    </div>
