...
<body class="mobile-body">
    ...
    $active_logs = ('view_logs.php' == $current_page) ? 'active' : '';
    ...
    <nav class="bottom-nav">
        <a href="index.php" class="nav-item <?php echo $active_home; ?>" data-page="index.php">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8h5z"/></svg>
            <span>ទំព័រដើម</span>
        </a>
        <a href="view_logs.php" class="nav-item <?php echo $active_logs; ?>" data-page="view_logs.php">
