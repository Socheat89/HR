...
// ត្រូវដាក់ Output Buffering នៅពីលើបំផុត ដើម្បីការពារ Header Sent Errors
// Enable gzip compression when available (reduces HTML/CSS/JS payload sizes)
...
// ===============================================
// 			CONFIGURATION (ត្រូវប្តូរ)
// ===============================================
define('DB_SERVER', 'localhost');
// ត្រូវប្តូរទៅជាព័ត៌មាន Database ពិតរបស់អ្នក
define('DB_USERNAME', 'samann1_attendance_db'); 
define('DB_PASSWORD', 'attendance@2025'); 	
define('DB_NAME', 'samann1_attendance_db'); 	

// លេខសម្គាល់ Admin ដំបូង (សម្រាប់តេស្ត)
define('DEFAULT_ADMIN_ID', 'ADMIN001');
define('DEFAULT_ADMIN_PASSWORD', 'adminpass');

// Telegram API Key (ត្រូវប្តូរជាមួយ Key ពិតប្រាកដរបស់អ្នក)
// **********************************************
define('TELEGRAM_BOT_TOKEN', '7680086124:AAHrvdz-mOx3pO1Ijqvh7BHTeGh2JB5JuwQ'); // ឧ. 123456789:ABC-DEF123456...
// **********************************************
...
// Ensure new employment columns & access logs table (idempotent)
ensure_employment_columns_and_logs($mysqli);

// Ensure noted column in checkin_logs
