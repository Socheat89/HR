...
// Database connection - Optimized with persistent connection
// ការតភ្ជាប់មូលដ្ឋានទិន្នន័យ - ធ្វើឱ្យប្រសើរជាមួយការតភ្ជាប់អចិន្ត្រៃយ៍
try {
    $dbOptions = [
    ...
    $db = new PDO("mysql:host=localhost;dbname=samann1_admin_panel;charset=utf8mb4", "samann1_admin_panel", "admin_panel@2025", $dbOptions);
...
try {
    ...
    $_SESSION['error'] = 'មានបញ្ហាក្នុងការទាញទិន្នន័យ។ សូមព្យាយាមម្តងទៀត។';
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .announcement-item { padding: 15px 0; border-bottom: 1px solid rgba(0, 0, 0, 0.05); transition: all 0.3s ease; }
        .announcement-item:hover { background: rgba(79, 70, 229, 0.05); }
        .announcement-item:last-child { border-bottom: none; }
        .announcement-title { font-weight: 600; margin-bottom: 5px; display: flex; align-items: center; gap: 8px; }
        .announcement-title i { color: var(--primary); font-size: 0.9rem; }
        .announcement-date { font-size: 0.8rem; color: var(--gray); margin-bottom: 8px; }
        .announcement-text { font-size: 0.95rem; line-height: 1.6; }
...
<body>
    ...
    <div class="app-container">
            ...
            <div class="user-profile">
                <div class="user-info">
                    <span class="user-name">
                        <?php echo htmlspecialchars($_SESSION['username'] ?? 'អ្នកចូល'); ?>
                    </span>
                    <span class="user-role">
                        <?php echo htmlspecialchars($_SESSION['role'] ?? 'Employee'); ?>
                    </span>
                </div>
        ...
        <div class="quick-actions">
            <a href="https://app.vvc.asia/admin/submit_request.php" class="action-card animate-fade-in-up" style="animation-delay: 0.1s">
            ...
            <a href="https://app.vvc.asia/menu_request.html" class="action-card animate-fade-in-up" style="animation-delay: 0.2s">
                <div class="action-content">
            ...
            <a href="checklist.php" class="action-card animate-fade-in-up" style="animation-delay: 0.3s">
                <div class="action-content">
            ...
            <a href="announcements.php" class="action-card animate-fade-in-up" style="animation-delay: 0.4s">
                <div class="action-content">
        ...
        <div class="dashboard-grid">
            <a href="daily_reports.php" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.1s">
            ...
            <a href="requests_menu.php" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.2s">
                <div class="card-content">
            ...
            <a href="/stock-control/user_request_form.php" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.3s">
                <div class="card-content">
            ...
            <a href="index20.html" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.4s">
                <div class="card-content">
            ...
            <a href="meeting_page.php" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.5s">
                <div class="card-content">
            ...
            <a href="survey.php" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.8s">
                <div class="card-content">
            ...
            <a href="input_mission.php" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.8s">
                <div class="card-content">
            ...
            <a href="attendance_menu.html" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.8s">
                <div class="card-content">
            ...
            <a href="lessons_documents.php" class="dashboard-card animate-fade-in-up" style="animation-delay: 0.8s">
                <div class="card-content">
            ...
            <!-- NEW VOTING CARD START -->
             <a href="employee_voting.php" class="dashboard-card animate-fade-in-up" style="animation-delay: 1.2s">
                <div class="card-content">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="announcements.php" class="btn btn-primary">មើលទាំងអស់</a>
                        <button type="button" class="btn btn-secondary" id="closeModalBtn" data-bs-dismiss="modal">បិទ</button>
                    </div>
                </div>
            </div>
        </div>
