...
<body>
    <button id="printButton" type="button"><i class="fa fa-print"></i> ព្រីន/Print</button>
    <script>
        document.getElementById('printButton').addEventListener('click', function () {
            try {
                ...
                alert('មិនអាចបើកមុខងារព្រីនបាន។ សូមពិនិត្យការកំណត់កម្មវិធីរុករករបស់អ្នក។ / Unable to open print dialog. Please check your browser settings.');
            }
        });
    </script>
    ...
    <div class="search-form">
        <form method="GET" action="">
            <label for="ref_no">លេខប័ណ្ណ/Ref No:</label>
            ...
            <label for="advance_type">ប្រភេទបុរេប្រទាន/Type of Advance:</label>
            ...
            <button type="submit"><i class="fa fa-search"></i> ស្វែងរក/Search</button>
        </form>
    ...
    <?php if ($request): ?>
        <div class="header">
            ...
            <h1>ក្រុមហ៊ុន វណ្ណ វណ្ណ ខេមបូឌា<br>VAN VAN CAMBODIA</h1>
            <div class="form-title">ប័ណ្ណស្នើសុំ<br>Request Form</div>
        </div>
        <div class="form-title2">
            <span style="font-weight: bold;">លេខប័ណ្ណ/Ref No: </span><?php echo htmlspecialchars($request['number'] ?? ''); ?><br />
            <span style="font-weight: bold;">ថ្ងៃស្នើសុំ/Request Date: </span><?php echo htmlspecialchars($request['request_date'] ?? ''); ?><br />
            <span style="font-weight: bold;">លេខប័ណ្ណស្នើសុំ/PR No: </span><?php echo htmlspecialchars($request['pr_no'] ?? ''); ?><br />
        </div>

        <div class="header-session">
            <table>
                <tr>
                    <td class="label">ឈ្មោះ/Name: <?php echo htmlspecialchars($request['request_person'] ?? ''); ?></td>
                   
                </tr>
                <tr>
                    <td class="label">មុខតំណែង/Position: <?php echo htmlspecialchars($request['position'] ?? ''); ?></td>
                 
                </tr>
                <tr>
                    <td class="label">ផ្នែក/Department: <?php echo htmlspecialchars($request['department'] ?? ''); ?></td>
                    
                </tr>
                <tr>
                    <td class="label">កូដគំរោង/Project: <?php echo htmlspecialchars($request['project'] ?? ''); ?></td>
                  
                </tr>
                <tr>
                    <td class="label">ថ្ងៃចង់បាន/Required Date: <?php echo htmlspecialchars($request['none_date'] ?? ''); ?></td>
               
                </tr>
            </table>
            <table>
                <tr>
                    <td class="label">ប្រភេទបុរេប្រទាន/Type of Advance:<br><br>☑ <?php echo htmlspecialchars($request['advance_type'] ?? ''); ?></td>
                </tr>
            </table>
        </div>
        <label>ថ្ងៃផុតកំណត់ការទូទាត់បុរេប្រទាន/Advance Clearance Deadline: <?php echo htmlspecialchars($request['deadline'] ?? ''); ?></label><br />

        <table class="bordered" style="margin-top: 5px;">
            <thead>
                <tr>
                    <th>ល.រ<br />No.</th>
                    <th>សេចក្ដីពិពណ៌នាអំពីការជំពាក់ប្រាក់<br />Purpose of Advance</th>
                    <th>បរិមាណ<br />Qty</th>
                    <th>តម្លៃឯកតា<br />Unit Price</th>
                    <th>ចំនួនទឹកប្រាក់<br />Amount</th>
                </tr>
            </thead>
            <tbody>
                <?php $total_amount = 0; ?>
                ...
                <?php endforeach; ?>
                <tr>
                    <td colspan="4" class="right"><strong>សរុបជំពាក់ប្រាក់/Total Amount Advance</strong></td>
                    <td><strong>$<?php echo number_format($total_amount, 2); ?></strong></td>
                </tr>
            </tbody>
        </table>
        <label>ជាអក្សរ/In Words: <?php echo htmlspecialchars($request['in_words'] ?? ''); ?></label><br />

        <table class="signature-block">
            <tr>
                <td class="label"></td>
                <td>ឈ្មោះ/Name:</td>
                <td>ហត្ថលេខា/Signature:</td>
                <td>កាលបរិច្ឆេទ/Date:</td>
            </tr>
            <tr>
                <td class="label">អ្នកស្នើសុំ/Requesting Person:</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
            </tr>
            <tr>
                <td class="label">ប្រធាន/Manager:</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
            </tr>
            <tr>
                <td class="label">ប្រធានផ្នែកហិរញ្ញវត្ថុ/Finance Manager:</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
            </tr>
            <tr>
                <td class="label">គណនេយ្យ/Accountant:</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
            </tr>
            <tr>
                <td class="label">អគ្គនាយក/Chief Executive Officer:</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
            </tr>
            <tr>
            <tr>
                <td class="label">អ្នកទទួល/Received:</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">_______________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
            </tr>
            <tr>
                <td class="label">អ្នកទទួលប្រាក់/Cashier:</td>
                <td style="padding-top: 1.5rem;">____________________</td>
                <td style="padding-top: 1.5rem;">_______________________</td>
                <td style="padding-top: 1.5rem;">____________________</td>
            </tr>
        ...
        <p style="margin-top: 15px;"><strong>សំគាល់ Note:</strong> សំរាប់គំរោង សូមភ្ជាប់ឯកសារពាក់ពន្ធ័។ For biz purpose, attach all relevant documents.<br />
            <em>សំរាប់បុរេប្រទានផ្ទាល់ខ្លួន ចំលងឲ្យផ្នែកធនធានមនុស្ស&ហិរញ្ញវត្ថុ។ For Personal Advance, a copy to HR&Finance Dept for record</em></p>
        <?php endif; ?>
    </body>
</html>