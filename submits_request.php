...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        echo "<h3 style='color: green; text-align: center;'>✅ Request submitted successfully!</h3>";
        echo "<div style='text-align: center;'><a href='request_form.php'>🔙 Back to form</a></div>";
    } catch (PDOException $e) {
